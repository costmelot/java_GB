...
public class Main {
    ...
    public static void main(String[] args) {
        int[] arrA = {-5, 10, 21, 3, 1, 2, 21};

        System.out.println("Наш массив до сортировки: " + Arrays.toString(arrA));
        Main heapSort = new Main();
        heapSort.sort(arrA);

        System.out.println("Наш массив после сортировки (HeapSort): " + Arrays.toString(arrA));
    }
}